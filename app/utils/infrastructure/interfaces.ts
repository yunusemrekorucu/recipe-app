...
export interface IStyleShortcuts {
  ...
  'bg-neutral30'?: StyleProp<ViewStyle> | boolean;
  ...
  absolute?: StyleProp<ViewStyle> | boolean | number;
  relative?: StyleProp<ViewStyle> | boolean | number;
  'justify-between'?: StyleProp<ViewStyle> | boolean;
...
export interface ITextStyles {
  ...
  semibold?: StyleProp<TextStyle> | boolean;
